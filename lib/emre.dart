...
import 'addNoteEmre.dart';
import 'editNote.dart';
void main() {
  runApp(emre_pg());
}
class emre_pg extends StatelessWidget {
...
class emre_page extends StatelessWidget {
  final ref = FirebaseFirestore.instance.collection("emre");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(child: Icon(Icons.add,color: Colors.white,),
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (_)=>AddNoteEmre()));
        } ,),
      body: StreamBuilder(
