...
import 'addNoteDennis.dart';
import 'editNote.dart';
void main() {
  runApp(dennis_pg());
}
class dennis_pg extends StatelessWidget {
...
class dennis_page extends StatelessWidget {
  final ref = FirebaseFirestore.instance.collection("dennis");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(child: Icon(Icons.add,color: Colors.white,),
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (_)=>AddNoteDennis()));
        } ,),
      body: StreamBuilder(
